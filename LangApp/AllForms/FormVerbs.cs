...
{
    public partial class FormVerbs : Form
    {
        public FormVerbs()
        {
            InitializeComponent();
        ...
        private void FormVerbs_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.Columns[8].HeaderText = "Verbs";
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {                
                if (isLastMonth)
                {
                    ...
                    {
                        year -= 1;
                        list = list.Where(x => x.MonthID == month - 1 && x.Year == year && x.WordCaseID == Convert.ToInt32(cmbCases.SelectedValue)).ToList();
                    }
                    else
                    {
                        list = list.Where(x => x.MonthID == month - 1 && x.Year == year && x.WordCaseID == Convert.ToInt32(cmbCases.SelectedValue)).ToList();
